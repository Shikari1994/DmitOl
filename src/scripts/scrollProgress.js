/* ─── Прогресс прокрутки сквозь прибитую сцену ───
   ...
   ведёт aboutScene.js, земной шар — globeCanvas.js. Оба обязаны считать
   ОДНО число: разойдись они на пару процентов — и список закончится не
   там, где шар доворачивается.
